    ...
    <div className="mt-3">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold">Gemini AI Tutor & Doubt Solver</span>
            ...
            <div className="mb-4 p-3.5 rounded-xl bg-amber-50 dark:bg-amber-950/40 border border-amber-300 dark:border-amber-800/80 text-amber-900 dark:text-amber-200 text-xs">
              <div className="flex items-start gap-2.5">
                ...
                <div className="space-y-1">
                  <strong className="font-bold block">GEMINI_API_KEY Not Configured in Server Environment</strong>
                  <p className="text-slate-700 dark:text-slate-300 leading-relaxed">
                    To enable real-time Gemini AI explanations and doubt resolution, add your <code className="bg-amber-100 dark:bg-amber-900/60 px-1 py-0.5 rounded font-mono text-[11px]">GEMINI_API_KEY</code> in <strong>Settings &gt; Secrets</strong> or server environment variables.
                  </p>
            ...
            <div className="py-6 px-4 text-center space-y-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-800 dark:text-slate-200">
                  Gemini is analyzing question #{mcq.id}...
                </p>
              ...
              <div className="mt-4 pt-4 border-t border-slate-200/80 dark:border-slate-800">
                <div className="flex items-center gap-2 mb-2.5">
                  ...
                  <h5 className="font-bold text-xs sm:text-sm text-slate-900 dark:text-white">
                    Still have a doubt? Ask your Gemini Tutor
                  </h5>
                </div>
                  ...
                  <input
                    ...
                    placeholder={
                      isKeyConfigured 
                        ...
                        : "Configure GEMINI_API_KEY to ask doubt questions"
                    }
